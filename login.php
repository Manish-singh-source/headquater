          ...
          <div class="form-body mt-4">
            <form class="row g-3">
              <div class="col-12">
                ...
                <input type="email" class="form-control" id="inputEmailAddress" placeholder="Manish@example.com">
              </div>
              <div class="col-12">
              ...
              <div class="col-12">
                <div class="d-grid">
                  <a href="index.php" type="submit" class="btn btn-grd-info">Login</a>
                </div>
              </div>
              <div class="col-12">
...
<!-- Mirrored from codervent.com/HEADQUATERS/demo/vertical-menu/auth-boxed-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Jun 2025 05:05:17 GMT -->
</html>