        ...
        <div class="main-content">
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-lg-2">
                            <th>
                                ...
                                <label for="checkbox2" class="form-label">Upload Invoice</label>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="div d-flex my-2">
                        <div class="col">
                            <h6 class="mb-3">Invoice Table</h6>
                        </div>
                        <div class="col-12 col-lg-1 text-end">
                            <button class="form-select" onclick="invoiceTable()">Hide Table</button>
                        </div>
                    </div>
                    <div class="product-table" id="invoiceTable">
                        <div class="table-responsive white-space-nowrap">
                            <table class="table align-middle">
                                <thead class="table-light">
                                    <tr>
