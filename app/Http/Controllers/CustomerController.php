...
class CustomerController extends Controller
{
    ...
    public function create($g_id = null)
    {
        ...
        return view('customer.create', compact('group_id', 'countries', 'states', 'cities'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'shipping_zip' => 'required|min:4|max:10',
            'billing_address' => 'required|min:5|max:255',
            'billing_country' => 'required',
            'billing_state' => 'required',
            'billing_city' => 'required',
            'billing_zip' => 'required|min:4|max:10',
    ...
    public function downloadGroupCustomersExcel(Request $request, $g_id)
    {
        try {
            ...
            return response()->download($tempXlsxPath, 'customers_group_' . $group->name . '.xlsx', [
