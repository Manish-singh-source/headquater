            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-2">
                    <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                        ...
                        <a href="{{ route('add-staff') }}" class="btn btn-primary px-4"><i class="bi bi-plus-lg me-2"></i>Add Staff</a>
                    </div>
                </div>
            </div><!--end row-->
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a aria-label="anchor" href="{{ route('staff-detail') }}" class="btn btn-icon btn-sm bg-primary-subtle me-1" data-bs-toggle="tooltip" data-bs-original-title="View">
