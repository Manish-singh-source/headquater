      ...
      <div class="card w-100 d-flex  flex-sm-row flex-col">
        <div class="col card-body d-flex">
          <div class="position-relative justify-content-center">
            <img src="{{asset($user->profile_image)}}" id="profilePreview" class="img-fluid rounded" alt="">
        ...
        <div class="col-12 col-xl-8">
          <div class="card rounded-4 border-top border-4 border-primary border-gradient-1">
            <div class="card-body p-4">
              ...
              <form action="{{ route('user.update', $user->id) }}" enctype="multipart/form-data" method="POST" class="row g-4">
                  @csrf
      @method('PUT')
                <div class="col-md-6">
                  <label for="input1" class="form-label">First Name</label>
                  <input type="text" class="form-control" name="fname" id="input1" placeholder="First Name" value="{{ $user->fname }}">
                </div>
                <div class="col-md-6">
                  <label for="input2" class="form-label">Last Name</label>
                  <input type="text" class="form-control" name="lname" id="input2" placeholder="Last Name" value="{{ $user->lname }}">
                </div>
                <div class="col-md-6">
                  <label for="input3" class="form-label">Phone</label>
                  <input type="text" class="form-control" name="phone" id="input3" placeholder="Phone" value="{{ $user->phone }}">
                </div>
                <div class="col-md-6">
                  <label for="input4" class="form-label">Email</label>
                  <input type="email" class="form-control" name="email" id="input4" placeholder="Email" value="{{ $user->email }}">
                </div>
                ...
                <div class="col-md-2">
                  ...
                  <input type="text" class="form-control" id="input10" placeholder="Zip" value="{{ $user->pincode }}">
                </div>
                 <div class="col-md-2">
                  <label for="input10" class="form-label">Profile Image</label>
                  <input type="file" class="form-control" id="inputProfileImage" name="profile_image" placeholder="Profile" accept="image/*">
                </div>
                <div class="col-md-12">
