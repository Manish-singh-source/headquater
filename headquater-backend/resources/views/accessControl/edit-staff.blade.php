                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <select class="form-control" name="role" id="role">
                                                    ...
                                                    <option value="Sales Person"
                                                        {{ $staff->role == 'Sales Person' ? 'selected' : '' }}>Sales Person
                                                    </option>
                                                    <option value="Operation Manager"
                                                        {{ $staff->role == 'Operation Manager' ? 'selected' : '' }}>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <input type="text" required="" name="city" id="city"
                                                    class="form-control" value="{{ $staff->city }}" placeholder="Enter City">
                                            </div>
                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <input type="text" name="state" id="state" class="form-control"
                                                    value="{{ $staff->state }}" placeholder="Enter State" required="">
                                            </div>
                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <input type="text" name="country" id="country" class="form-control"
                                                   value="{{ $staff->country }}" required="" placeholder="Enter Country">
                                            </div>
                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <input type="text" name="pincode" id="pincode" class="form-control"
                                                   value="{{ $staff->pincode }}" required="" placeholder="Enter Pincode">
                                            </div>
                                        </div>
                                    </div>
                                </div>
