                        ...
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-lg-2">
                                            <label for="pick-date" class="form-label">Received Date</label>
                                        ...
                                        <div class="col-12 col-lg-2 text-md-end">
                            ...
                            <div class="col-lg-12">
                                <div class="row justify-content-between mb-3">
                                    <div class="col-6"><a href="raise-a-ticket-form.php" type="" class="btn btn-success w-sm waves ripple-light">
                                            Raise A Ticket
                                        </a></div>
                                    <div class="col-6 text-end"><a href="{{route('products') }}" type="" class="btn btn-success w-sm waves ripple-light">
                                        Save
                                    </a></div>
                                </div>
                            </div>
