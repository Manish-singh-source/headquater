            ...
            <div class="row g-3">
                    ...
                    <div class="btn-group position-static">
                        <div class="btn-group position-static">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="javascript:;">Sort By Order Id</a></li>
                                <li><a class="dropdown-item" href="javascript:;">Sort By Customer Name</a></li>
                            </ul>
                        </div>
                        <div class="btn-group position-static">
                            <button type="button" class="btn btn-filter dropdown-toggle px-4" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="javascript:;">Completed</a></li>
                ...
                <div class="col-12 col-md-auto">
                    <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                        ...
                        <a href="{{ route('add-order') }}"><button class="btn btn-primary px-4"><i class="bi bi-plus-lg me-2"></i>New Order</button></a>
                    </div>
                </div>
            </div><!--end row-->
                            ...
                            <table id="example2" class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a aria-label="anchor" href="{{ route('customer-order-view') }}" class="btn btn-icon btn-sm bg-primary-subtle me-1" data-bs-toggle="tooltip" data-bs-original-title="View">
