            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-auto">
                    <div class="d-flex align-items-center gap-2 justify-content-lg-end">
                        ...
                        <a href="{{route('create-warehouse') }}"><button class="btn btn-primary px-4"><i class="bi bi-plus-lg me-2"></i>Add Warehouse</button></a>
                    </div>
                </div>
            </div><!--end row-->
                            ...
                            <table id="example2" class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a aria-label="anchor" href="{{route('warehouse-detail') }}" class="btn btn-icon btn-sm bg-primary-subtle me-1" data-bs-toggle="tooltip" data-bs-original-title="View">
