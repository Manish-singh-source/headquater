                            ...
                            <tbody>
                               @forelse ($customer as $customer)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a aria-label="anchor" href="{{ route('customer-detail' ,$customer->id) }}" class="btn btn-icon btn-sm bg-primary-subtle me-1" data-bs-toggle="tooltip" data-bs-original-title="View">
                                            ...
                                            <a aria-label="anchor" href="{{ route('edit_customer',$customer->id) }}" class="btn btn-icon btn-sm bg-warning-subtle me-1" data-bs-toggle="tooltip" data-bs-original-title="Edit">
                                            ...
                                            <form action="{{ route('delete-customer', $customer->id) }}" method="POST" onsubmit="return confirm('Are you sure?')">
                                                @csrf
                                                @method('DELETE')
