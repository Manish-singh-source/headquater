...
@section('main-content')
    ...
    <main class="main-wrapper">
        <div class="main-content">
            <div class="row">
                <form action="{{ route('import-large-csv') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="col-12">
                        <div class="row">
                            <div class="col">
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3 align-items-end">
                                            ...
                                            <div class="col-12 col-lg-1">
                                                ...
                                                {{-- <button type="submit" class="btn btn-primary" id="save-customers">Save</button> --}}
                                ...
                                <div class="card customer-groups">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <a href="#" class="btn btn-primary" id="save-customers">Save</a>
                                        </div>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="staticBackdropLabel">Hold
                                                            Products</h1>
