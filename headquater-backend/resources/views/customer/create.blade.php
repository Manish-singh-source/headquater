                            ...
                            <form class="row g-3" action="{{ route('customer.store') }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control  @error('contact_name') is-invalid @enderror"
                                        value="{{ old('contact_name') }}" id="contact_name" placeholder="Enter Contact Name"
                                        name="contact_name">
                                    @error('contact_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" class="form-control  @error('email') is-invalid @enderror"
                                        value="{{ old('email') }}" id="email" placeholder="Enter Email" name="email">
                                    @error('email')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control  @error('contact_no') is-invalid @enderror"
                                        value="{{ old('contact_no') }}" id="contact_no" placeholder="Enter Contact Number"
                                        name="contact_no">
                                    @error('contact_no')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control  @error('companyName') is-invalid @enderror"
                                        value="{{ old('companyName') }}" id="companyName" placeholder="Enter Company Name"
                                        name="companyName">
                                    @error('companyName')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control  @error('gstin') is-invalid @enderror"
                                        value="{{ old('gstin') }}" id="gstin" placeholder="Enter GST Number"
                                        name="gstin">
                                    @error('gstin')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control  @error('pan') is-invalid @enderror"
                                        value="{{ old('pan') }}" id="pan" placeholder="Enter PAN Number"
                                        name="pan">
                                    @error('pan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control  @error('shippingAddress') is-invalid @enderror" value="" id="shippingAddress"
                                        placeholder="Enter Full Address" rows="3" name="shippingAddress">{{ old('shippingAddress') }}</textarea>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('shippingPinCode') }}" id="shippingPinCode"
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control  @error('billingAddress') is-invalid @enderror" value="" id="billingAddress"
                                        placeholder="Enter Full Address" rows="3" name="billingAddress">{{ old('billingAddress') }}</textarea>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('billingPinCode') }}" id="billingPinCode"
