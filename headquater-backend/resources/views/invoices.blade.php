                                                    ...
                                                    <div class="modal-body">
                                                        <form>
                                                            <div class="col-12 mb-3">
                                                                <label for="document_image" class="form-label">Appointment
                                                                    Date <span class="text-danger">*</span></label>
                                                                <input type="date" name="document_image"
                                                                    id="document_image" class="form-control"
                                                                    value="" required=""
                                                                    placeholder="Upload ID Document">
                                                            </div>
                                                            <div class="col-12 mb-3">
                                                                <label for="document_image" class="form-label">Upload POD
                                                            ...
                                                            <div class="col-12 mb-3">
                                                                <label for="document_image" class="form-label">Upload GRN
                                                                    <span class="text-danger">*</span></label>
                                                                <input type="file" name="document_image"
                                                                    id="document_image" class="form-control"
                                                                    value="" required=""
                                                            ...
                                                            <div class="col-12 mb-3">
                                                                <label for="document_image" class="form-label">Upload
                                                                    E-Invoice <span class="text-danger">*</span></label>
                                                                <input type="file" name="document_image"
                                                                    id="document_image" class="form-control"
                                                                    value="" required=""
                                                                    placeholder="Upload ID Document">
                                                            ...
                                                            <div class="col-12 mb-3">
                                                                <label for="document_image" class="form-label">DN
                                                                    Amount<span class="text-danger">*</span></label>
                                                                <input type="text" name="document_image"
                                                                    id="document_image" class="form-control"
                                                                    value="" required=""
                                                            ...
                                                            <div class="col-12 mb-3">
                                                                <label for="document_image" class="form-label">Upload
                                                                    E-Way Bill<span class="text-danger">*</span></label>
                                                                <input type="file" name="document_image"
                                                                    id="document_image" class="form-control"
                                                                    value="" required=""
                                                                    placeholder="Upload ID Document">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form>
                                                            <div class="col-12 mb-3">
                                                                <label for="utr_no" class="form-label">UTR No<span
                                                                        class="text-danger">*</span></label>
                                                                <input type="text" name="document_image"
                                                                    id="utr_no" class="form-control" value=""
                                                                    required="" placeholder="UTR No">
                                                            </div>
                                                            <div class="col-12 mb-3">
                                                                <label for="payment_method" class="form-label">Update
                                                                    Payment Method<span
                                                                        class="text-danger">*</span></label>
                                                            ...
                                                            <div class="col-12 mb-3">
                                                                <label for="document_image" class="form-label">Update
                                                                    Payment Status<span
                                                                        class="text-danger">*</span></label>
