                        ...
                        <table id="example2" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a aria-label="anchor" href="{{ route('detail-vendor',$vendor->id) }}" class="btn btn-icon btn-sm bg-primary-subtle me-1" data-bs-toggle="tooltip" data-bs-original-title="View">
                                            ...
                                            <a aria-label="anchor" href="{{ route('edit-vendor',$vendor->id) }}" class="btn btn-icon btn-sm bg-warning-subtle me-1" data-bs-toggle="tooltip" data-bs-original-title="Edit">
                                            ...
                                            <form action="{{ route('delete-vendor', $vendor->id) }}" method="POST" onsubmit="return confirm('Are you sure?')">
                                                @csrf
                                                @method('DELETE')
                                            ...
                                            <a aria-label="anchor"  data-bs-toggle="tooltip" data-bs-original-title="Delete">
