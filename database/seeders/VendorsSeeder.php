    ...
    public function run(): void
    {
        ...
        DB::table('vendors')->insert([
            ...
            [
                ...
                'gst_treatment' => null,
                'pan_number' => null,
                'billing_address' => 'John Doe PRIVATE LIMITED Gat No. 43/1-P and 46-P, Village-Bhamboli, Tal-Khed Pune, Maharashtra - 410507, India',
                'billing_country' => '101',
                'billing_state' => '4008',
                'billing_city' => '2047',
                'billing_zip' => '124501',
                'shipping_address' => 'John Doe CLOUDSTORE RETAIL PRIVATE LIMITED Gat No. 43/1-P and 46-P, Village-Bhamboli, Tal-Khed Pune, Maharashtra - 410507, India',
                'shipping_country' => '101',
                'shipping_state' => '4008',
                'shipping_city' => '2047',
                'shipping_zip' => '124501',
                'status' => '1',
                'vendor_code' => 'Vendor-3',
                'created_at' => '2025-08-30 05:56:12',
                'updated_at' => '2025-08-30 05:56:12',
            ],
        ]);
