                            ...
                            <table id="productTable" class="table align-middle">
                                ...
                                <tbody>
                                    @forelse ($products as $product)
                                        @php
                                            $productData = \App\Models\Product::where('warehouse_id', $product->warehouse_id)
                                        ...
                                        @if ($productData?->id)
                                            <tr>
                                                <td>
                                                    @if (optional($productData)->id)
                                                        <input class="form-check-input row-checkbox" type="checkbox"
                                                            name="ids[]" value="{{ $productData?->id }}">
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <div class="product-info">
                                                            <a href="javascript:;"
                                                                class="product-title">{{ $productData?->brand ?? 'NA' }}</a>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <a aria-label="anchor" data-id="{{ $productData?->id }}"
