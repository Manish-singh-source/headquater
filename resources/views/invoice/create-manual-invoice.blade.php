    ...
    <main class="main-wrapper">
        <div class="main-content">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h6 class="mb-0">Customer Selection</h6>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <span id="po_number_message" class="text-danger"></span>
                                        @error('po_number')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end"><span id="paymentStatusBadge"
                                                class="badge bg-secondary">Unpaid</span></td>
                                    </tr>
                                </table>
            ...
            <div class="modal fade" id="addCustomerModal" data-bs-backdrop="static" data-bs-keyboard="false"
                tabindex="-1" aria-labelledby="addCustomerModalLabel" aria-hidden="true">
                        ...
                        <form id="addCustomerForm" method="POST">
                            ...
                            <div class="modal-body">
                                    ...
                                    <div class="d-flex gap-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="customer_type"
                                                id="typeGroup" value="group" checked>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="customer_type"
                                                id="typeIndividual" value="individual">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="billing_address" id="billing_address" class="form-control" rows="2"
    ...
    <script>
        $(document).ready(function() {
            $('#po_number').on('input', function() {
                ...
                // display message if po number is already exists or not
                $.ajax({
                    url: '{{ route('check.po.number') }}',
                    type: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        po_number: $(this).val()
                    ...
                    success: function(response) {
                        // disable create invoice button if po number is already exists
                        if (response.success) {
                            $('#po_number_message').text(response.message).removeClass('text-danger').addClass('text-success');
                            $('#createInvoiceBtn').prop('disabled', true);
                        } else {
                            $('#po_number_message').text(response.message).removeClass('text-success').addClass('text-danger');
