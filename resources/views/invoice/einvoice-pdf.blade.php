...
<body>
    ...
    @foreach (['Original Copy', 'Duplicate Copy', 'Triplicate Copy'] as $copyIndex => $copyLabel)
        @if ($copyIndex > 0)
        ...
        <table>
            <tr class="invoice-table">
                ...
                <td colspan="3" class="right-align"> {{ ucfirst(numberToWords(floor($totalAmountSum))) }} Rupees
                    Only
                </td>
            </tr>
        </table>
