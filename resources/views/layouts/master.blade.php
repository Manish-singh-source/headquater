              ...
              <ul class="navbar-nav gap-1 nav-right-links align-items-center">
                  ...
                  <li class="nav-item dropdown">
                      <a href="javascrpt:;" class="dropdown-toggle dropdown-toggle-nocaret"
                          ...
                          <img src="{{ Auth::user()->profile_image ?? Avatar::create(Auth::user()->fname)->toBase64() }}" class="rounded-circle p-1 border" width="45"
                              height="45" alt="">
                      </a>
                      <div class="dropdown-menu dropdown-user dropdown-menu-end shadow">
                          <a class="dropdown-item  gap-2 py-2" href="javascript:;">
                              <div class="text-center">
                                  <img src="{{ Auth::user()->profile_image ?? Avatar::create(Auth::user()->fname)->toBase64() }}" class="rounded-circle p-1 shadow mb-3"
