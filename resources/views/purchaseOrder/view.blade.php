                        ...
                        <div class="d-flex justify-content-between align-items-center my-2">
                            ...
                            <div class="div d-flex justify-content-end my-3 gap-2">
                                @if (
                                    ...
                                    @endisset
                                @empty($purchaseOrder->sales_order_id)
                                    <button class="btn btn-sm border-2 border-primary" data-bs-toggle="modal"
                                        data-bs-target="#customPO" class="btn btn-sm border-2 border-primary">
                                        Add Vendor PI
                                    </button>
                                @endempty
                            @endif
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="customPO" data-bs-backdrop="approve"
                                data-bs-keyboard="false" tabindex="-1" aria-labelledby="approveBackdropLabel"
                                aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="{{ route('custom.purchase.order.store') }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            @method('POST')
                                            <div class="modal-header">
