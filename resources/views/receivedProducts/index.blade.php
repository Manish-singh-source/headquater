                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Received Products</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="customer-table">
                        <div class="table-responsive white-space-nowrap">
                            <table id="packaging-orders" class="table table-striped">
...
@section('script')
    <script>
        $(document).ready(function() {
            var packagingOrders = $('#packaging-orders').DataTable({
                "columnDefs": [{
                    "orderable": false,
                }],
                lengthChange: true,
            ...
            $('.status-filter-tab').on('click', function() {
                ...
                packagingOrders.column(3).search(selected ? '^' + selected + '$' : '', true, false).draw();
            });
        });
