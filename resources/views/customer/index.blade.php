                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <h4 class="mb-0">{{ $totalCustomersCount ?? 0 }}</h4>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <h4 class="mb-0 text-success">{{ $activeCustomersCount ?? 0 }}</h4>
                                </div>
                                <div class="flex-shrink-0">
                                    <div class="avatar-sm">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <h4 class="mb-0 text-secondary">{{ $inactiveCustomersCount ?? 0 }}
                                    </h4>
                                </div>
                                <div class="flex-shrink-0">
                                    <div class="avatar-sm">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-pills mb-3" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link {{ $status === null ? 'active' : '' }}"
                                href="{{ route('customer.index', ['status' => null]) }}">
                                All Customers
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link {{ $status === 1 ? 'active' : '' }}"
                                href="{{ route('customer.index', ['status' => 1]) }}">
                                Active
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link {{ $status === 0 ? 'active' : '' }}"
                                href="{{ route('customer.index', ['status' => 0]) }}">
                                Inactive
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="customer-table">
                        <div class="table-responsive white-space-nowrap">
                            <table id="customerTable" class="table table-striped cell-border">
